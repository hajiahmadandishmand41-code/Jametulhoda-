...
## پنل مدیریت — Phase 4.2 تا 4.8

مخزن محتوا، CRUD محتوای خبری و انواع مقاله/گزارش/رویداد، workflow انتشار، رسانه، موضوعات و روابط از Repositoryها و routeهای محافظت‌شده استفاده می‌کنند. Viewها فقط داده‌ی آماده را نمایش می‌دهند و SQL ندارند. آپلودها با MIME واقعی، اندازه، نام تصادفی و پوشه‌ی بدون اجرای PHP کنترل می‌شوند. هیچ قابلیت Phase 5 در این پیاده‌سازی وجود ندارد.
